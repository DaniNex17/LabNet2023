...
const routes: Routes = [
  ...
  { path:'agregarEmpleados', component: AgregarEditarEmpleadoComponent },
  { path:'verEmpleados/:id', component: VerEmpleadoComponent },
  { path:'editarEmpleados/:id', component: AgregarEditarEmpleadoComponent },
  { path:'**', redirectTo: 'listEmpleados', pathMatch: 'full'},
];
